...
if (typeof(window) !== 'undefined') {
	...
	(function(exports) {
				...
				$.ajax({
					...
					success: function(payload) {
						...
						if(results.length === 50){
							...
							//todo: why isn't this a problem?
							//not then'ing this promise, where does it return too?
							make_request(url_object,cache).then(function(){done(cache)})
						}
						else{
		...
		exports.load_all_tracks = function(){
			...
			//todo: lowering to two we know work (see notes)
			...
			Promise.all(promises).then(function(results){
				console.log("promise all finished with:",results);
			})
		};
		...
		var token = "BQBFlTd0OQsbm_JyRCL-58so4XuBYDH3FPUXaNCNvwBJucZzFup6Qzg2xg9gkktfT3v2-LXlGjYqpVyRcBkl9egQQPIaRg_T-CjdM5VSY3xcIDSu2L9MVDM_2GWw7XS8NS4TlBh7egmBxKDiA-jhPD7k_ogOXtVkE0syPWnOFFqysCQJo6SoQKo"
