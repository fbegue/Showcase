		...
		if (typeof(window) !== 'undefined') {
			...
			(function(exports) {
				...
				// var doCalendar = function(){
					...
					var CLIENT_ID = '446469140888-768cqn734osc24j0o3cltrbrtlej9336.apps.googleusercontent.com';
					//secret:iNPWx1vaV2IMFQijkAO-IX7Q

					var API_KEY = 'AIzaSyB_7zsaH5YG74mxwzK_vFcTnDVo4npXLmA';
					...
					function listUpcomingEvents() {
						...
						var event = {
							...
							'start': {
								'dateTime': '2019-11-12T20:56:02.372Z',
								'timeZone': 'America/Los_Angeles'
							},
							'end': {
								'dateTime': '2019-11-12T21:56:02.372Z',
								'timeZone': 'America/Los_Angeles'
							},
							'recurrence': [
						...
						var request = gapi.client.calendar.events.insert({
							//'calendarId': 'primary',
							'calendarId': '8ktpulckak8bl8ebm6j5e3f230@group.calendar.google.com',
							'resource': event
						});
							...
							return gapi.client.calendar.calendarList.list({})
								.then(function(response) {
										...
										response.result.items.forEach(function(i){
											i.accessRole === "owner" ? console.log( i.id + "|" +i.summary ):{};
										})
									},
				...
				let controller = module.controller("myCtrl", function($scope,$http,linker) {
					...
					$("#gapi").load(function() {
						console.log( "ready!" );
						authorizeButton = $('#authorize_button')[0];
						signoutButton = $('#signout_button')[0];
						handleClientLoad()
					});
